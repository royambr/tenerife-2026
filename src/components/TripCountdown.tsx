...
export function TripCountdown() {
  ...
  if (today < TRIP_START) {
    ...
    return (
      <div className={CARD}>
        ...
        <div className="text-[13px] font-extrabold text-white mt-1">עוד {days} ימים</div>
        <div className="text-[10px] text-white/60 font-medium">לטנריף 🌋</div>
      </div>
    );
  }
  ...
  if (today === TRIP_START) {
    return (
      <div className={CARD}>
        ...
        <div className="text-[13px] font-extrabold text-white mt-1">היום מתחיל</div>
        <div className="text-[10px] text-white/60 font-medium">המסע ✈️</div>
      </div>
    );
  }
  ...
  return (
    <div className={CARD}>
      <div className="text-2xl leading-none">🌊</div>
      <div className="text-[13px] font-extrabold text-white mt-1">יום {dayNum} מתוך 8</div>
      <div className="text-[10px] text-white/60 font-medium">בטנריף</div>
    </div>
  );
}
